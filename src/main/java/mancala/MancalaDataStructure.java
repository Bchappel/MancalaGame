...
public class MancalaDataStructure implements Serializable{
    ...
    public List<Countable> getBoard() {
        return data;
    }

    public void setBoard(List<Countable> newBoard) {
        this.data = newBoard;
    }
...
//#region ADDING/REMOVING
    ...
    public int getPlayerStorePosition(int playerNum) {
        return storePos(playerNum);
    }
    ...
    private int storePos(int playerNum) {
        if(playerNum < 1 || playerNum > 2){
            throw new RuntimeException("Invalid Player Position -1 ");
        }
